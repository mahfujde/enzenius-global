    ...
    <div className="bg-white">
      ...
      <section className="bg-primary text-white py-24 text-center">
        <div className="container mx-auto px-6">
          <h1 className="text-5xl font-black mb-6 uppercase tracking-tighter">Our Comprehensive Services</h1>
          <p className="text-xl text-blue-100 max-w-2xl mx-auto">From early counseling to settling into your dorm, we provide end-to-end support for your international education journey.</p>
        </div>
      </section>
